...
WORKDIR $GOPATH/src/github.com/edgexfoundry/device-coap-go
...
COPY --from=builder /go/src/github.com/edgexfoundry/device-coap-go/cmd /

ENTRYPOINT ["/device-coap-go","--profile=docker","--confdir=/res","--registry=consul://edgex-core-consul:8500"]
